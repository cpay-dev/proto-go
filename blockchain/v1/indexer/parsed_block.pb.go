...
type ParsedBlock struct {
	...
	Transfers         []*ParsedTransfer      `protobuf:"bytes,5,rep,name=transfers,proto3" json:"transfers,omitempty"`
...
const file_blockchain_v1_indexer_parsed_block_proto_rawDesc = "" +
	"\n" +
	"(blockchain/v1/indexer/parsed_block.proto\x12\x1acpay.blockchain.v1.indexer\x1a!blockchain/v1/indexer/types.proto\"\xba\x02\n" +
	"\vParsedBlock\x127\n" +
	...
	"\x0fblock_timestamp\x18\x04 \x01(\x04R\x0eblockTimestamp\x12H\n" +
	"\ttransfers\x18\x05 \x03(\v2*.cpay.blockchain.v1.indexer.ParsedTransferR\ttransfers\"\xa5\x01\n" +
